...
// To get the different pattern/mining types, change the number in line of code from 2 to something else:

// const delta = this.chunkSideLength * 2;
// A 1 will make it mine normally

// A 2 will give you the really small checker pattern (the best, imo)

// A 4 will make a wider pattern (not too efficient, imo, unless just searching for space types)